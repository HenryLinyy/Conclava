...
Each conversation is a JSON file under `~/.conclava/conversations/<id>.json`.
...
logger = logging.getLogger("conclava.conversation_store")


def _default_store_dir() -> Path:
    """Default storage directory: ~/.conclava/conversations/."""
    return Path.home() / ".conclava" / "conversations"

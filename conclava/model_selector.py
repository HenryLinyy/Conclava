...
from conclava.model_roles import ModelRole, RoleSelection, WorkflowStage
from conclava.workflows import (
    STAGE_ROLE_MAP,
    ...
    def model_for_role(self, role: ModelRole) -> str:
        ...
        mapping = {
            ...
            ModelRole.EXECUTOR: (
                ...
                else (c.model_role_executor or c.model_coder or c.model_tooler)
            ),
            ModelRole.REPAIR: (
                c.model_qwable
                if c.enable_qwable_executor and c.model_qwable
                else (c.model_role_repair or c.model_coder or c.model_tooler)
            ),

"""Conclava SDK client (sync + async).
...
from conclava_sdk.types import FusionPreset, FusionPresetName, FusionResult


# Default model aliases — can be overridden per call.
MODEL_OPENAI = "conclava-fusion"
MODEL_ANTHROPIC = "claude-conclava-fusion"


class ConclavaClient:
    """Python client for Conclava.
    ...
    def fusion_chat(
        ...
        *,
        ...
        Parameters:
            ...
            model: External model id (default: "conclava-fusion")

...
def test_client_custom_init():
    ...
    client = ConclavaClient(base_url="http://example.com:9000/", timeout=60.0)
...
def test_fusion_chat_non_streaming_builds_correct_body():
    ...
    assert sent_body["model"] == "conclava-fusion"
